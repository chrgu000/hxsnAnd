...
import com.hxsn.hf.login.TestDpsdkCoreActivity;
		...
		Callback callback = new Callback() {
			...
			public boolean handleMessage(Message msg) {
				...
				case MSG_LIVE_OPEN_SOUND:
					...
					//closeTalk();
					playSound(true);
					btnSound.setText("关闭声音");
					break;
				case MSG_LIVE_CLOSE_SOUND:	
					btnSound.setText("打开声音");
					playSound(false);
					break;
				...
				case MSG_LIVE_CLOSE_TALK:
					...
					btnTalk.setText("打开对讲");
					closeTalk();
				case MSG_LIVE_TALK_SUCCUSS:
					mProgressDialog.dismiss();
					Toast.makeText(OperateSoundTalk.this, "打开对讲成功", Toast.LENGTH_SHORT).show();
					break;
				case MSG_LIVE_TALK_FAIL:
					 mProgressDialog.dismiss();
		             Toast.makeText(OperateSoundTalk.this, "打开对讲失败" + ",errCode:" + msg.arg1, Toast.LENGTH_SHORT).show();
					break;
				case MSG_LIVE_STOP_TALK_SUCCUSS:
					Toast.makeText(OperateSoundTalk.this, "关闭对讲成功", Toast.LENGTH_SHORT).show();
					break;
				case MSG_LIVE_STOP_TALK_FAIL:
					Toast.makeText(OperateSoundTalk.this, "关闭对讲失败" + ",errCode:" + msg.arg1, Toast.LENGTH_SHORT).show();
					break;
					}
