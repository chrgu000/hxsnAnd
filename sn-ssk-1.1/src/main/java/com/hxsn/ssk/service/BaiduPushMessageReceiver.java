...
public class BaiduPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId) {
        ...
        if(errorCode == 0){//绑定成功
           LogUtil.i("BaiduPushMessageReceiver", "----------------------------绑定成功-----------------------");
        }else {
           LogUtil.i("BaiduPushMessageReceiver", "----------------------------绑定失败-----------------------");
    ...
    public void onUnbind(Context context, int i, String s) {
       LogUtil.i(TAG, "onUnbind-responseString=" + s);
    }
    ...
    public void onSetTags(Context context, int errorCode, List<String> successTags, List<String> failTags, String requestId) {
        String responseString = "onSetTags errorCode=" + errorCode
                ...
                + " requestId=" + requestId;
       LogUtil.i(TAG, "onSetTags-" + responseString);
    ...
    public void onDelTags(Context context, int i, List<String> list, List<String> list1, String s) {
       LogUtil.i(TAG, "onDelTags-"+s);
    }

    @Override
    public void onListTags(Context context, int i, List<String> list, String s) {
       LogUtil.i(TAG, "onListTags-"+s);
    }
    ...
    public void onMessage(Context context, String message, String customContentString) {
       ...
       LogUtil.i(TAG, "onMessage-" + messageString);
    }
    ...
    public void onNotificationClicked(Context context, String title, String description, String customContentString) {
       ...
       LogUtil.i(TAG, "onNotificationClicked-notifyString=" + notifyString);
    ...
    public void onNotificationArrived(Context context, String title, String description, String customContentString) {
        ...
        String notifyString = "onNotificationArrived  title=\"" + title
                ...
                + customContentString;
       LogUtil.i(TAG, "onNotificationArrived-notifyString=" + notifyString);
