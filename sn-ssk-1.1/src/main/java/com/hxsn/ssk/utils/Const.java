...
public class Const {
    ...
    public static String URL_HEAD_NONGSH_IMAGE = TApplication.URL_CMS_STRING;//农事汇图标地址头
    public static String URL_NONGSH_INFO = TApplication.URL_CMS_STRING+"/app/xwzx.do?chid=";
    public static String URL_WNN_LIST = TApplication.URL_CMS_STRING+"/app/wzj.do?username=";
    ...
    //获取CMS系统用户信息
    public static String URL_GET_CMS_USER_INFO = TApplication.URL_CMS_STRING + "/app/userinfo.json?username=";
