...
import com.andbase.gson.internal.$Gson$Preconditions;
...
public final class GsonBuilder {
   ...
   * <a href="http://code.com/p/google-gson/issues/detail?id=42">Gson Issue 42</a>
   * for details.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   * @since 1.3
   ...
   * that do not have the {@link } annotation.
   *
   * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
   */
