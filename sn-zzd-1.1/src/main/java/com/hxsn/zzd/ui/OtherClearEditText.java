...
public class OtherClearEditText extends EditText implements
    ...
    public OtherClearEditText(Context context) {
        this(context, null);
        this.context = context;
    }

    public OtherClearEditText(Context context, AttributeSet attrs) {
//这里构造方法也很重要，不加这个很多属性不能再XML里面定义
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public OtherClearEditText(Context context, AttributeSet attrs, int defStyle) {
