...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        if (width < height) {
            LogUtil.i(TAG, "Display reports portrait orientation; assuming this is incorrect");
            int temp = width;
            width = height;
            height = temp;
        }
    ...
    void setDesiredCameraParameters(Camera camera) {
        ...
        if (parameters == null) {
            LogUtil.i(TAG, "Device error: no camera parameters are available. Proceeding without configuration.");
            return;
        }
    ...
    private static String findSettableValue(Collection<String> supportedValues, String... desiredValues) {
        LogUtil.i(TAG, "Supported values: " + supportedValues);
        String result = null;
